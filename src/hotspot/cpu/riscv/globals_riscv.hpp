...
define_pd_global(uintx, CodeCacheSegmentSize, 1984); // Tiered compilation has large code-entry alignment.
define_pd_global(intx, CodeEntryAlignment,       8);
define_pd_global(intx, OptoLoopAlignment,        8);
